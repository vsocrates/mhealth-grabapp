...
char ssid[48] = "CaseGuest";           // your network SSID (name) 
...
//    return;
  ...
  if (!SD.begin(chipSelect)){
    Serial.println("initializign failed again here");
  } else {
    Serial.println("intialiiziaont fixed");
  }
  ...
  if (dataFile) {
    Serial.println("TESTING: 1,2,3,,4,55,");
    dataFile.println("TESTING: 1,2,3,,4,55,");
    dataFile.close();
    Serial.println("SD File has written to!");
